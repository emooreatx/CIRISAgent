...
def register_discord_adapter(
    ...
    register_response = requests.post(
        f"{api_url}/v1/system/adapters/discord",
        json=config,
        headers=headers
    )
    ...
    if register_response.status_code == 200:
        ...
        print(f"   ✓ Discord adapter registered successfully!")
    ...
    if status_response.status_code == 200:
        ...
        if our_adapter:
            print(f"   ✓ Adapter found in system")
    ...
    print(f"   The bot should now be online in Discord.")
    print(f"   Check the logs for connection status: docker logs ciris")
