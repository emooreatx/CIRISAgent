...
from .const import CONF_API_KEY, CONF_API_URL, CONF_CHANNEL, CONF_TIMEOUT, DEFAULT_TIMEOUT, DOMAIN
    ...
    async def async_process(self, user_input: conversation.ConversationInput) -> conversation.ConversationResult:
        ...
        try:
            ...
            if interact_response.status_code == 200:
                ...
                intent_response.async_set_speech("I encountered an error processing your request.")

        except httpx.TimeoutException:
            intent_response.async_set_speech("CIRIS is taking too long to respond. Please try again.")
        except Exception as e:
            _LOGGER.error("Error processing with CIRIS: %s", e)
            intent_response.async_set_speech("I encountered an error. Please try again later.")
