...
from ciris_engine.logic.services.graph.tsdb_consolidation.consolidators.memory import MemoryGraphConsolidator
...
async def main():
    ...
    print("=" * 80)
    print("Period: 2025-07-03 12:00:00 to 18:00:00")
    print("\nBefore:")
