...
from ciris_engine.logic.services.mixins import RequestMetrics, RequestMetricsMixin
...
def test_request_metrics_schema_validation():
    ...
    metrics = RequestMetrics(
        requests_handled=100, error_count=5, average_response_time_ms=25.5, success_rate=95.0, last_request_time=None
    )
