...
from ciris_engine.schemas.task_schemas_v1 import Task
from ciris_engine.schemas.thought_schemas_v1 import Thought
...
class APIVisibilityRoutes:
    ...
    def __init__(self, bus_manager: Any, telemetry_collector: Any) -> None:
