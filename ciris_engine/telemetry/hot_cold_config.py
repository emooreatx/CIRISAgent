...
HOT_COLD_PATH_CONFIG: Dict[str, PathConfig] = {
    ...
    "guardrail_check": PathConfig("hot", True, "raw", 30.0),
...
MODULE_CONFIGS: Dict[str, ModulePathConfig] = {
    "ciris_engine.processor.thought_processor": ModulePathConfig(
        ...
        hot_types={"Thought", "ActionSelectionResult", "ThoughtContext", "DMAResults"},
        cold_types={"GuardrailResult", "EpistemicData"},
    ...
    "ciris_engine.action_handlers": ModulePathConfig(
        ...
        hot_types={"ActionSelectionResult", "DispatchContext", "HandlerActionType"},
