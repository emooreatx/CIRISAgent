...
class BaseCollector(ABC):
    ...
    def __init__(
        ...
        self._last_collection = self.time_service.get_current_time()
...
class InstantCollector(BaseCollector):
    ...
    def __init__(
        ...
        super().__init__(interval_ms=50, time_service=time_service, max_metrics_per_interval=10)
...
class FastCollector(BaseCollector):
    ...
    def __init__(
        ...
        super().__init__(interval_ms=250, time_service=time_service, max_metrics_per_interval=20)
        self.telemetry_service = telemetry_service
...
class NormalCollector(BaseCollector):
    ...
    Used for resource usage and consciences.
    """
    ...
    def __init__(
        ...
        super().__init__(interval_ms=1000, time_service=time_service, max_metrics_per_interval=50)
        self.telemetry_service = telemetry_service
...
class SlowCollector(BaseCollector):
    ...
    def __init__(
        ...
        super().__init__(interval_ms=5000, time_service=time_service, max_metrics_per_interval=30)
        self.telemetry_service = telemetry_service
...
class AggregateCollector(BaseCollector):
    ...
    def __init__(
        ...
        super().__init__(interval_ms=30000, time_service=time_service, max_metrics_per_interval=100)
        self.telemetry_service = telemetry_service
    ...
    async def process_metrics(self, metrics: List[MetricData]) -> None:
        ...
        if self.audit_service:
            ...
            await self.audit_service.log_action(
                ...
                {"metrics_count": len(metrics), "timestamp": self.time_service.get_current_time().isoformat()},
                "success"
            )
