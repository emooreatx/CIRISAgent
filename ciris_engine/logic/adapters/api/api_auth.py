...
class APIAuthRoutes:
    ...
    async def _handle_create_agent(self, request: web.Request) -> web.Response:
        ...
        try:
            ...
            time_service = self.runtime.bus_manager.get_service('time')
            timestamp = time_service.get_current_time()
    ...
    async def _handle_initialize_agent(self, request: web.Request) -> web.Response:
        ...
        try:
            ...
            # Get time service from runtime
            time_service = self.runtime.bus_manager.get_service('time')
            identity_data['initialization_timestamp'] = time_service.get_current_time().isoformat()
