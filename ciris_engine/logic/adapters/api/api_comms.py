...
class APICommsRoutes:
    def __init__(self, api_observer: Any, api_adapter: Any, time_service: Optional[TimeServiceProtocol] = None, service_registry: Optional[Any] = None) -> None:
    ...
    def _get_time_service(self) -> Optional[TimeServiceProtocol]:
        """Get TimeService from direct injection or registry."""
    ...
    async def _handle_get_messages(self, request: web.Request) -> web.Response:
        try:
            ...
            try:
                ...
                if not time_service:
                    logger.error("TimeService not available - cannot get current time")
