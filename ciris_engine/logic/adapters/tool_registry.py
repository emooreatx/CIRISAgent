...
from ciris_engine.schemas.services.tools_core import ToolDescription, ToolParameter, ToolParameterType
...
class ToolRegistry:
    ...
    def _convert_legacy_schema(self, name: str, schema: dict) -> ToolDescription:
        """Convert legacy schema format to ToolDescription."""
        parameters = []
