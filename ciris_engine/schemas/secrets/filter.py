...
class ConfigExport(BaseModel):
    ...
    default_patterns: list = Field(default_factory=list, description="Default patterns")
    additional_config: dict = Field(default_factory=dict, description="Additional configuration")
