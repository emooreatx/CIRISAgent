...
class SummaryAttributes(BaseModel):
    ...
    messages_by_channel: Optional[Dict[str, Union[int, dict]]] = Field(default=None)
    participants: Optional[Dict[str, dict]] = Field(default=None)
...
class EdgeAttributes(BaseModel):
    ...
    metadata: Dict[str, Union[str, int, float, bool]] = Field(
        ...
        description="Edge metadata - typed values only"
    )
