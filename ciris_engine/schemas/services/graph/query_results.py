...
class ServiceCorrelationQueryResult(BaseModel):
    ...
    service_interactions: List[ServiceInteractionData] = Field(
        ...
        description="Service interaction correlations"
    )
    metric_correlations: List[MetricCorrelationData] = Field(
        default_factory=list,
        description="Metric correlations"
    )
    trace_spans: List[TraceSpanData] = Field(
        default_factory=list,
        description="Trace span correlations"
    )
    task_correlations: List[TaskCorrelationData] = Field(
        default_factory=list,
        description="Task correlations"
    )
