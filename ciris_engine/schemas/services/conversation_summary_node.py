...
class ConversationSummaryNode(TypedGraphNode):
    ...
    conversations_by_channel: Dict[str, List[Dict[str, Any]]] = Field(
        ...
        description="Full conversation history by channel"
    )
    ...
    user_list: List[str] = Field(
        ...
        description="List of user IDs who interacted"
    )
    
    # Service interaction metrics
    action_counts: Dict[str, int] = Field(
        default_factory=dict,
        description="Count of each action type (speak, observe, etc.)"
    )
    service_calls: Dict[str, int] = Field(
        default_factory=dict,
        description="Count of calls to each service"
    )
    ...
    sentiment_summary: Optional[Dict[str, float]] = Field(
        None,
        description="Sentiment analysis if available"
    )
