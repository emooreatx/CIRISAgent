...
from ciris_engine.schemas.dma.core import DMADecision
...
class VisibilitySnapshot(BaseModel):
    ...
    recent_decisions: List[Thought] = Field(default_factory=list, description="Recent thoughts with their decisions (final_action)")
...
class ThoughtStep(BaseModel):
    ...
    conscience_results: Optional[dict] = Field(None, description="Conscience evaluation results (non-terminal actions)")
