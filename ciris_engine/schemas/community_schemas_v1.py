...
class CommunityHealth(BaseModel):
    ...
    activity_level: SchemaVersion = Field(default=50, ge=0, le=100)
    conflict_level: SchemaVersion = Field(default=0, ge=0, le=100)  
    helpfulness: SchemaVersion = Field(default=50, ge=0, le=100)
    flourishing: SchemaVersion = Field(default=50, ge=0, le=100)  # Composite from Annex A
...
class MinimalCommunityContext(BaseModel):
    ...
    community_id: SchemaVersion
    member_count: SchemaVersion = 0
