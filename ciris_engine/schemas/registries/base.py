...
class RegistryInfo(BaseModel):
    ...
    handlers: Dict[str, Dict[str, List[ProviderInfo]]] = Field(default_factory=dict, description="Handler-specific services")
    global_services: Dict[str, List[ProviderInfo]] = Field(default_factory=dict, description="Global services")
    circuit_breaker_stats: Dict[str, CircuitBreakerStats] = Field(default_factory=dict, description="Circuit breaker statistics")