...
class AgentTemplate(BaseModel):
    ...
    # DMA overrides
    dsdma_kwargs: Optional['DSDMAConfiguration'] = Field(
        None,
        description="Domain-specific DMA configuration"
    )
    csdma_overrides: Optional['CSDMAOverrides'] = Field(
        None,
    ...
    discord_config: Optional['DiscordAdapterOverrides'] = Field(
        None,
        description="Discord adapter configuration overrides"
    )
    api_config: Optional['APIAdapterOverrides'] = Field(
        None,
        description="API adapter configuration overrides"
    )
    cli_config: Optional['CLIAdapterOverrides'] = Field(
        None,
        description="CLI adapter configuration overrides"
    )
...
class DSDMAConfiguration(BaseModel):
    ...
    domain_specific_knowledge: Optional[Dict[str, Union[str, List[str], Dict[str, str]]]] = Field(
        None,
        description="Domain-specific knowledge like rules, principles, examples"
    )
