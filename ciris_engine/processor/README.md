...
The core thought processing pipeline that coordinates DMA orchestration, context building, and guardrails.
...
5. **Apply Guardrails**: Validate and potentially override actions
...
- **Guardrail Violation**: When guardrails block actions
...
- Applies guardrails to processing results
- Handles guardrail overrides and escalations
- Ensures ethical and safe action selection
