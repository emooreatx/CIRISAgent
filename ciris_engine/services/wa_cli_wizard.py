...
class WACLIWizardService:
    ...
    async def _create_root_wa(self) -> Dict[str, Any]:
    ...
    async def _import_root_cert(self) -> Dict[str, Any]:
    ...
    async def _join_wa_tree(self) -> Dict[str, Any]:
    ...
    async def _configure_oauth(self) -> Dict[str, Any]:
