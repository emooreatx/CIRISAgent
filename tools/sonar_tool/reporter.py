...
class QualityReporter:
    ...
    def generate_coverage_report(self, analysis: Dict[str, Any]) -> str:
        ...
        lines = [
            "=" * 80,
            f"CIRIS Code Coverage Analysis Report",
        ...
        if analysis['package_analysis']:
            lines.extend([
                "## Package Analysis",
                "Modules with most uncovered code:",
                ""
            ])
    ...
    def generate_tech_debt_report(self, issues: List[Dict], 
                                 debt_files: List[Dict]) -> str:
        """Generate technical debt report."""
        lines = [
            "=" * 80,
            f"CIRIS Technical Debt Report",
            f"Generated: {self.report_time}",
            "=" * 80,
            ""
        ]
        ...
        for rule, count in sorted(type_counts.items(), 
    ...
    def generate_action_summary(self, analysis: Dict[str, Any]) -> str:
        ...
        lines = [
            "CIRIS Quality Action Summary",
            "=" * 40,
            "",
            "🎯 TOP 5 FILES TO TEST NOW:",
            ""
        ]
    ...
    def export_json_report(self, analysis: Dict[str, Any], 
                          filename: str = "sonar_analysis.json") -> None:
